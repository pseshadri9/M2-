 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Sanket Manjesh");
		  toPrint += p1.toString("smanjesh3");
		  ...
		  Person3 p3 = new Person3("Kevin Doyle");
		  toPrint += p3.toString("kdoyle31");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Mridul Bansal");
                  toPrint += p4.toString("mbansal31");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Nicholas Grana");
                  toPrint += p5.toString("ngrana3");
     ...
     * @param args values passed through command line
     */
